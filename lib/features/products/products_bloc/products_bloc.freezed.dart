...
mixin _$ProductsState {
  Map<String, ProductsModel> get productsData =>
      throw _privateConstructorUsedError;
...
abstract class $ProductsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {Map<String, ProductsModel> productsData,
      bool isLoading,
      String? errorMessage});
}
...
class _$ProductsStateImpl implements _ProductsState {
  const _$ProductsStateImpl(
      {required final Map<String, ProductsModel> productsData,
      required this.isLoading,
      this.errorMessage})
      : _productsData = productsData;

  final Map<String, ProductsModel> _productsData;
  @override
  Map<String, ProductsModel> get productsData {
    if (_productsData is EqualUnmodifiableMapView) return _productsData;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_productsData);
  }
  ...
  @override
  String toString() {
    return 'ProductsState(productsData: $productsData, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
